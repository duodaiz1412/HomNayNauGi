...
type EditIngredientScreenRouteProp = RouteProp<AdminIngredientStackParamList, 'EditIngredientScreen'>
    ...
    return (
      <SafeAreaView className="flex-1 bg-gray-50">
        <View className="flex-1 justify-center items-center">
          ...
          <Text className="mt-4 text-gray-600">Đang tải thông tin nguyên liệu...</Text>
        </View>
      </SafeAreaView>
    )
  }
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} className="flex-1">
        <ScrollView className="flex-1 px-4 py-4">
          ...
          <TouchableOpacity
            ...
            disabled={isLoading}
          >
            <Text className="text-white font-bold">{isLoading ? "Đang xử lý..." : "Cập nhật nguyên liệu"}</Text>
          </TouchableOpacity>
        </ScrollView>
      </KeyboardAvoidingView>
    </SafeAreaView>
