...
type EditIngredientCategoryScreenRouteProp = RouteProp<
  AdminIngredientCategoryStackParamList,
  'EditIngredientCategoryScreen'
>;
    ...
    const fetchCategory = async () => {
      try {
        ...
        const reponse = await api.get(
          `/admin/ingredient-categories/search/${ingredientCategoryId}`
        );
